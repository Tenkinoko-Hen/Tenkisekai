...
namespace litefeel
{
    ...
    public class FntParse
    {
        ...
        public void DoXMLPase(ref string content)
        {
            ...
            //lineHeight = ToFloat(common, "lineHeight");
            //lineBaseHeight = ToFloat(common, "base");
            ...
            for (int i = 0; i < chars.Count; i++)
            {
                ...
                lineHeight = ToInt(charNode, "height");
                lineBaseHeight = lineHeight / 2;
            }
        ...
        private void ReadTextCommon(ref string line)
        {
            ...
            for (int i = keys.Length - 1; i >= 0; i--)
            {
                switch (keys[i])
                {
                    //case "lineHeight": lineHeight = float.Parse(values[i]); break;
                    //case "base": lineBaseHeight = float.Parse(values[i]); break;
